...
def generate_response(prompt):
    ...
    ssl_context = ssl.SSLContext(ssl.PROTOCOL_TLSv1_2)  # Adjust the protocol as needed
    try:
        response = requests.post(url, headers=headers, json=payload, verify=True, timeout=10, ssl_context=ssl_context)
